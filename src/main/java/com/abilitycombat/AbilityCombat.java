...
import com.abilitycombat.ability.list.AkashicRecord;
import com.abilitycombat.ability.list.ApexScope;
...
import com.abilitycombat.ability.list.Boxer;
...
import com.abilitycombat.ability.list.ExecutionTime;
import com.abilitycombat.ability.list.ExplosionMark;
import com.abilitycombat.ability.list.FireFightWithFire;
import com.abilitycombat.ability.list.FirstAidKit;
import com.abilitycombat.ability.list.FlameBrand;
import com.abilitycombat.ability.list.Flora;
import com.abilitycombat.ability.list.ForYouOnly;
import com.abilitycombat.ability.list.Gambler;
...
import com.abilitycombat.ability.list.GustArrow;
...
import com.abilitycombat.ability.list.OutlawsGrit;
import com.abilitycombat.ability.list.Pacifist;
import com.abilitycombat.ability.list.PenetrationArrow;
import com.abilitycombat.ability.list.Poltergeist;
import com.abilitycombat.ability.list.ProbabilisticDefense;
import com.abilitycombat.ability.list.PuppetMaster;
import com.abilitycombat.ability.list.Pumpkin;
import com.abilitycombat.ability.list.RedBeard;
import com.abilitycombat.ability.list.Revenge;
...
import com.abilitycombat.ability.list.Solar;
...
import com.abilitycombat.ability.list.TankEngine;
...
public final class AbilityCombat extends JavaPlugin {
    ...
    private void registerAbilities() {
        ...
        AbilityFactory.register(Boxer.class);
        ...
        AbilityFactory.register(GustArrow.class);
        AbilityFactory.register(ProbabilisticDefense.class);
        AbilityFactory.register(Chaos.class);
        AbilityFactory.register(Gambler.class);
        AbilityFactory.register(Revenge.class);
        AbilityFactory.register(PuppetMaster.class);
        AbilityFactory.register(AkashicRecord.class);
        AbilityFactory.register(FlameBrand.class);
        AbilityFactory.register(OutlawsGrit.class);
        AbilityFactory.register(ForYouOnly.class);
        AbilityFactory.register(ExecutionTime.class);
        AbilityFactory.register(ApexScope.class);
        AbilityFactory.register(FirstAidKit.class);
        AbilityFactory.register(Pacifist.class);
        AbilityFactory.register(TankEngine.class);
        AbilityFactory.register(Luna.class);
        AbilityFactory.register(Solar.class);
        AbilityFactory.register(ExplosionMark.class);
    }
}
